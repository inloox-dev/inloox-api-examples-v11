...
namespace InLooxApiSamplesv11.Models
{
    ...
    public class CustomDynamicProject : ApiDynamicProject
    {
        // CustomFields can be queried:
        // public string? Project_cf_2283e9e4_CFDTest { get; set; }  

        // to see all available fields (including custom fields) open the following URL when you´re logged in in your browser
        // Cloud URL:  https://app.inloox.com/api/odata/dynamicproject
        // OnPrem URL: https://YOUR-ON-PREM-URL.com/api/v1/odata/dynamicproject
    }
}
